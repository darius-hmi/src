...
rnd_clf = RandomForestClassifier(n_estimators=512, max_leaf_nodes=74, max_depth=None, bootstrap=False, max_features='sqrt', min_samples_leaf=13, min_samples_split=12,
...
predictions = rnd_clf.predict_proba(finalpred)
