...
predictions = model.predict_proba(finalpred)
...
# # Initialize RandomizedSearchCV with verbose=3 to show progress and n_iter to control the number of settings tested
# random_search = RandomizedSearchCV(estimator=model, param_distributions=param_grid, 
#                                    scoring='accuracy', n_iter=10, cv=3, verbose=3, n_jobs=-1, random_state=42)
...
# # If you want to make predictions with the best model
...
# predictions = best_model.predict_proba(match_data_scaled)
