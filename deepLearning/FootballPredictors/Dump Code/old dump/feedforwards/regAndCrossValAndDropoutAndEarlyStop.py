...
def build_and_train_model(X_train, y_train):
    ...
    # model.add(Dense(256, input_dim=X_train.shape[1], kernel_regularizer=regularizers.l2(0.01)))
    # model.add(BatchNormalization())  # Adding Batch Normalization
    # model.add(LeakyReLU(alpha=0.1))  # Using LeakyReLU as activation

    # # Hidden layers
    # model.add(Dense(128, kernel_regularizer=regularizers.l2(0.01)))
    # model.add(BatchNormalization())  # Adding Batch Normalization
    # model.add(LeakyReLU(alpha=0.1))  # LeakyReLU to prevent dead neurons
    # model.add(Dropout(0.3))  # Dropout with 30% rate

    # model.add(Dense(64, kernel_regularizer=regularizers.l2(0.01)))
    # model.add(BatchNormalization())  # Batch normalization for better learning
