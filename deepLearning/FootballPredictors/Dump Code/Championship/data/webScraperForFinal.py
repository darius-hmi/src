...
def fetch_and_process_data(season):
    ...
    if season == '2024/2025':
        url1 = "https://fbref.com/en/comps/10/schedule/Championship-Scores-and-Fixtures"
        url2 = "https://fbref.com/en/comps/10/Championship-Stats"
    else:
        # Modify URL for past seasons
        season_formatted = season.replace('/', '-')
        url1 = f"https://fbref.com/en/comps/10/{season_formatted}/schedule/{season_formatted}-Championship-Scores-and-Fixtures"
        url2 = f"https://fbref.com/en/comps/10/{season_formatted}/{season_formatted}-Championship-Stats"
