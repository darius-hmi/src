...
if __name__ == "__main__":
    ...
    features_scaled, target, label_encoder_home, label_encoder_away, scaler, home_stats, away_stats = prepare_data('data/final.csv', decay_factor=0.1)
    ...
    predicted_outcome, predicted_probability = predict_match_result(xgb_model, scaler, label_encoder_home, label_encoder_away, home_stats, away_stats, home_team, away_team)
