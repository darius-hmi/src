...
def exponential_decay_weight(df, decay_factor, current_season='2024/2025', current_season_matches=10):
    ...
    #Maybe delete the line below if it is not making much of a difference
    weights[df['Season'] == current_season] *= (current_season_matches / 38)
...
if __name__ == "__main__":
    ...
    features_pca, target, label_encoder_home, label_encoder_away, scalar, pca, home_stats, away_stats = prepare_data('data/final44_newFeatures.csv', decay_factor=0.1, n_components=100)
    ...
    home_teams = ['Bournemouth', 'Ipswich Town', 'Liverpool', 'Nott\'ham Forest', 'Southampton', 'Newcastle Utd']
    away_teams = ['Manchester City', 'Leicester City', 'Brighton', 'West Ham', 'Everton', 'Arsenal']
    wk = '10' 
