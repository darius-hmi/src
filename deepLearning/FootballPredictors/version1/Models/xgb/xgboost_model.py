...
data = pd.read_csv('../NeuralNetworks/fianlForReal.csv')
...
for home_team, away_team in matches_to_predict:
    ...
    probabilities = model.predict_proba(match_data_scaled)

    # Decode probabilities
    home_win_prob = probabilities[0][1]  # Adjust this based on the actual class index for 'home win'
    draw_prob = probabilities[0][0]     # Adjust for 'draw'
    away_win_prob = probabilities[0][2] # Adjust for 'away win'
