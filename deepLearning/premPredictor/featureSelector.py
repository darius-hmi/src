...
# Load the dataset
df = pd.read_csv('data/combined_fixtures_with_results.csv')

# Initial feature and target selection
features = [
        'Home', 'xG', 'xG.1', 'Away', 'Referee',
        # Home team stats
...
categorical_features = ['Home', 'Away', 'Referee', 'Season', 'Home_Annual Wages', 'Home_Weekly Wages', 'Away_Weekly Wages', 'Away_Annual Wages']  # List your categorical columns here
